...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_oscseguros_dev_oscseguros_assa.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_oscseguros_dev_oscseguros_assa.inc';
}
// </DDSETTINGS>

if (file_exists('/var/www/site-php')) {
    require('/var/www/site-php/oscseguros/oscseguros_assa-settings.inc');
}
